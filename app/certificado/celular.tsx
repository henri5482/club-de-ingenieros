      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-center gap-16 md:gap-24 mb-24 md:mb-36">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-[#26374c] mb-8 max-w-md">
            Cada uno de tus certificados incluye un <strong className="text-red-600">código QR único</strong>.
            Al escanearlo, cualquier persona podrá <strong className="text-red-600">verificar al instante la autenticidad de tu certificado online</strong>.
            ¡Demuestra tus logros con total confianza!
          </p>
        </motion.div>
          ...
          <div className="relative w-[90%] h-[calc(100%-4rem)] bg-white rounded-2xl overflow-hidden shadow-inner">
            ...
            <div className="flex items-center justify-between p-3 bg-gray-50 border-b border-gray-200">
              ...
              <span className="text-xs text-gray-500 font-semibold">
                tu-certificado.com/verificar
              </span> {/* Changed URL for relevance */}
            ...
            <div className="flex flex-col items-center justify-center p-4 bg-white">
              ...
              <div className="relative w-48 h-48 md:w-56 md:h-56 bg-white border border-gray-300 rounded-lg flex items-center justify-center p-2">
                <Image
                  src={qrCodeImage}
                  alt="Código QR del certificado" // More specific alt text
                  width={200}
                  height={200}
              ...
              <p className="text-xs text-[#26374c] mt-2 text-center">
                Verifica la autenticidad de tu logro
              </p> {/* Changed text */}
            </div>
          </div>
        </motion.div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-24 items-start mb-24 md:mb-36">
        ...
        >
          <h1 className="text-3xl md:text-4xl font-extrabold text-[#26374c] mb-4 leading-tight">
            Personalizados, únicos y <span className="text-red-600">Avalados</span>
          </h1>
          <p className="text-lg md:text-xl text-[#26374c] max-w-md mx-auto md:mx-0">
            Tu certificado, es único y lleva tu nombre.
            Además, cuenta con el respaldo de la <strong className="text-red-600">Cámara de Comercio de Lima</strong>,
            el <strong className="text-red-600">Club de Ingenieros</strong> y <strong className="text-red-600">Educare Internacional</strong>, asegurando su validez.
          </p>
        </motion.div>
        {/* Right Text Block */}
        <motion.div
