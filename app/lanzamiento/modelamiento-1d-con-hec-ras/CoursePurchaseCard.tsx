    ...
    return (
      ...
      >
        ...
        <div className="relative w-full rounded-lg overflow-hidden mb-6">
          <Image
            src="/lanzamiento/modelamiento-1d/banner.webp"
  ...
  return (
    ...
    >
      ...
      <div className="mb-6 pb-6 border-b border-gray-200">
        ...
        <div className="flex items-end mb-4">
          <span className=" md:text-3xl  text-xl font-extrabold text-red-600 mr-2">
            S/ 99.00
          </span>
          <span className="md:text-lg text-sm text-gray-500 line-through">S/ 199.00</span>
          <span className="text-green-600 font-semibold ml-auto text-sm md:text-lg">50% Dto.</span>
        </div>
        <motion.div
          initial="hidden"
          animate="visible"
