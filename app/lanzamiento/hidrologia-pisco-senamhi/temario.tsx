...
const Temario: React.FC = () => {
    ...
    >
      ...
      <motion.div className="mb-8" variants={itemVariants}>
        ...
        <p className="text-gray-700 text-base sm:text-lg leading-relaxed">
          Este curso tiene como objetivo principal capacitar a estudiantes y
          profesionales en el análisis hidrológico aplicado, utilizando datos
          climáticos como PISCO y estaciones SENAMHI, aplicando técnicas de corrección
          de datos como Quantile Mapping con R, y desarrollando simulaciones
          hidrológicas distribuidas en HEC-HMS. Se prioriza un enfoque práctico para
          integrar herramientas como QGIS, R y Excel en el procesamiento, análisis,
          visualización y exportación de datos hidrometeorológicos con fines técnicos y
          académicos.
        </p>
      </motion.div>
      ...
      <motion.div className="mb-8" variants={itemVariants}>
        ...
        <ul className="list-disc list-inside space-y-2 text-gray-700 text-base sm:text-lg">
          ...
          <li>Aplicación práctica de técnicas estadísticas y de corrección con R.</li>
  ...
  ampliamente utilizadas en análisis hidrológico:
</p>
<ul className="list-none space-y-2 sm:space-y-3 pl-0">
  <li className="flex items-center text-gray-700 text-base sm:text-lg">
    ...
    <span><strong>QGIS</strong>: para la delimitación de cuencas e insumos espaciales.</span>
  </li>
  <li className="flex items-center text-gray-700 text-base sm:text-lg">
    <Link className="h-4 w-4 sm:h-5 sm:w-5 text-gray-500 mr-2 sm:mr-3 flex-shrink-0" />
    <span><strong>R y RStudio</strong>: para análisis estadístico y Quantile Mapping.</span>
  </li>
  <li className="flex items-center text-gray-700 text-base sm:text-lg">
    <Link className="h-4 w-4 sm:h-5 sm:w-5 text-gray-500 mr-2 sm:mr-3 flex-shrink-0" />
    <span><strong>HEC-HMS</strong>: para modelación hidrológica distribuida.</span>
  </li>
  <li className="flex items-center text-gray-700 text-base sm:text-lg">
    <Link className="h-4 w-4 sm:h-5 sm:w-5 text-gray-500 mr-2 sm:mr-3 flex-shrink-0" />
    <span><strong>Microsoft Excel</strong>: para revisión preliminar de datos y cálculos básicos.</span>
  </li>
</ul>
...
<ul className="list-none space-y-2 sm:space-y-3 pl-0">
  <li className="flex flex-col sm:flex-row sm:items-center text-gray-700 text-base sm:text-lg py-2 rounded-md hover:bg-gray-50 transition-colors">
    <div className="flex items-center mb-2 sm:mb-0 sm:flex-1">
      ...
      <span>Guía PDF para instalación de QGIS, R y HEC-HMS.</span>
    </div>
  </li>
  <li className="flex flex-col sm:flex-row sm:items-center text-gray-700 text-base sm:text-lg py-2 rounded-md hover:bg-gray-50 transition-colors">
    <div className="flex items-center mb-2 sm:mb-0 sm:flex-1">
  ...
  <li className="flex flex-col sm:flex-row sm:items-center text-gray-700 text-base sm:text-lg py-2 rounded-md hover:bg-gray-50 transition-colors">
    <div className="flex items-center mb-2 sm:mb-0 sm:flex-1">
      <BookText className="h-4 w-4 sm:h-5 sm:w-5 text-gray-500 mr-2 sm:mr-3 flex-shrink-0" />
      <span>Archivos de proyecto HEC-HMS configurados y datos .met</span>
    </div>
  </li>
</ul>
